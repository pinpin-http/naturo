...
/*!***********************************************!*\
  !*** ./resources/js/backoffice/popper.min.js ***!
  \***********************************************/
...
var t = function () {
  ...
  for (var _o = 0; _o < t.length; _o += 1) if (e && 0 <= navigator.userAgent.indexOf(t[_o])) return 1;
  return 0;
}();
function o(e) {
  var t = !1;
...
function re(e, t) {
  ...
  return w = Math.max(Math.min(i[s] - h, w), 0), e.arrowElement = o, e.offsets.arrow = _defineProperty(_defineProperty({}, a, Math.round(w)), l, ''), e;
}
function pe(e) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ve);
/******/ })()
;