...
/*!*********************************************************!*\
  !*** ./resources/js/backoffice/smooth-scrollbar.min.js ***!
  \*********************************************************/
  ...
  return function (t) {
    ...
    t.exports = function (t, e, n) {
      ...
      if (i(t, "function" != typeof g || !(y || x.forEach && !l(function () {
        new g().entries().next();
      })))) b = n.getConstructor(e, t, v, m), c.REQUIRED = !0;else if (i(t, !0)) {
        var _ = new b(),
          E = _[m](y ? {} : -0, 1) != _,
          O = l(function () {
            _.has(1);
    ...
    (t.exports = function (t, e, n, f, l) {
      ...
      if (l) p = t;else {
        ...
        if (o(h)) {
          for (d = 0, v = i(t.length); v > d; d++) if ((y = f ? x(r(g = t[d])[0], g[1]) : x(t[d])) && y instanceof s) return y;
          return new s(!1);
        }
        p = h.call(t);
      }
      for (m = p.next; !(g = m.call(p)).done;) if ("object" == _typeof(y = a(p, x, g.value, f)) && y && y instanceof s) return y;
      return new s(!1);
    }).stop = function (t) {
      return new s(!0, t);
    };
    ...
    var r,
      ...
      _h = function h() {
        ...
        for (var t = u.length; t--;) delete _h.prototype[u[t]];
        return _h();
      };
    ...
    t.exports = function (t, e, n, f, h, g, x) {
      ...
      if (j && (b = i(j.call(new t())), d !== Object.prototype && b.next && (l || i(b) === d || (u ? u(b, d) : "function" != typeof b[y] && a(b, y, m)), c(b, E, !0, !0), l && (p[E] = m))), "values" == h && A && "values" !== A.name && (O = !0, P = function P() {
        return A.call(this);
      }), l && !x || T[y] === P || a(T, y, P), p[e] = P, h) if (w = {
        values: _("values"),
        keys: g ? P : _("keys"),
        entries: _("entries")
      }, x) for (S in w) !v && !O && S in T || s(T, S, w[S]);else r({
        target: e,
        proto: !0,
        forced: v || O
      }, w);
    ...
    var r = n(19),
      ...
      s = function s(t) {
        ...
        return function (h, d, v, y) {
          for (var m, g, x = i(h), b = o(x), w = r(d, v, 3), S = u(b.length), _ = 0, E = y || c, O = e ? E(h, S) : n ? E(h, 0) : void 0; S > _; _++) if ((p || _ in b) && (g = w(m = b[_], _, x), t)) if (e) O[_] = g;else if (g) switch (t) {
            case 3:
              return !0;
            case 5:
              return m;
    ...
    t.exports = function (t) {
      var e,
        ...
        x = s(d),
        b = 0;
      if (g && (m = r(m, y > 2 ? arguments[2] : void 0, 2)), null == x || v == Array && u(x)) for (n = new v(e = c(d.length)); e > b; b++) h = g ? m(d[b], b) : d[b], a(n, b, h);else for (p = (l = x.call(d)).next, n = new v(); !(f = p.call(l)).done; b++) h = g ? i(l, m, [f.value, b], !0) : f.value, a(n, b, h);
      return n.length = b, n;
    };
  }, function (t, e, n) {
    "use strict";
    ...
    ***************************************************************************** */
    ...
    function u(t, e, n, r) {
      ...
      if ("object" == (typeof Reflect === "undefined" ? "undefined" : _typeof(Reflect)) && "function" == typeof Reflect.decorate) u = Reflect.decorate(t, e, n, r);else for (var c = t.length - 1; c >= 0; c--) (o = t[c]) && (u = (i < 3 ? o(u) : i > 3 ? o(e, n, u) : o(e, n)) || u);
    ...
    function f(t) {
      var e = a.get(t) || [];
      return a.set(t, e), function (t, n, r) {
        function o(t) {
        ...
        return Object.defineProperty(t.prototype, "parent", {
          ...
          void 0 === t && (t = this.offset.x), void 0 === e && (e = this.offset.y), void 0 === n && (n = 0), void 0 === r && (r = {}), function (t, e, n, r, o) {
            ...
            var p = f.x,
              ...
              v = g(n, 0, l.y) - h,
              y = Date.now();
            cancelAnimationFrame(P.get(t)), function e() {
              var n = Date.now() - y,
    ...
    var Q = function (t) {
      ...
      }, e.version = "8.8.4", e.ScrollbarPlugin = z, e;
    }(U);
    e["default"] = Q;
  }])["default"];
});
