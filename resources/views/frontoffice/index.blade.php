...
@section('content')
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item position-relative" style="min-height: 100vh;">
                    <img class="position-absolute w-100 h-100" src="/images/frontoffice/carousel-2.jpg" style="object-fit: cover;">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="text-white text-uppercase mb-3 animate__animated animate__fadeInDown" style="letter-spacing: 3px;">Spa & Beauty Center</h6>
                ...
                <div class="carousel-item position-relative" style="min-height: 100vh;">
                    <img class="position-absolute w-100 h-100" src="/images/frontoffice/carousel-3.jpg" style="object-fit: cover;">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="text-white text-uppercase mb-3 animate__animated animate__fadeInDown" style="letter-spacing: 3px;">Spa & Beauty Center</h6>
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-6 pb-5 pb-lg-0">
                    <img class="img-fluid w-100" src="/images/frontoffice/about.jpg" alt="">
                </div>
                <div class="col-lg-6">
    ...
    <div class="container-fluid px-0 py-5 my-5">
        ...
        <div class="owl-carousel service-carousel">
            <div class="service-item position-relative">
                <img class="img-fluid" src="/images/frontoffice/service-1.jpg" alt="">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="/images/frontoffice/service-2.jpg" alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="/images/frontoffice/service-3.jpg" alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="/images/frontoffice/service-4.jpg" alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="/images/frontoffice/service-5.jpg" alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="/images/frontoffice/service-6.jpg" alt="">
                <div class="service-text text-center">
            ...
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="/images/frontoffice/opening.jpg" style="object-fit: cover;">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="/images/frontoffice/pricing.jpg" style="object-fit: cover;">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="team position-relative overflow-hidden mb-5">
                        <img class="img-fluid" src="/images/frontoffice/team-1.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team position-relative overflow-hidden mb-5">
                        <img class="img-fluid" src="/images/frontoffice/team-2.jpg" alt="">
                        <div class="position-relative text-center">
                            <div class="team-text bg-primary text-white">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team position-relative overflow-hidden mb-5">
                        <img class="img-fluid" src="/images/frontoffice/team-3.jpg" alt="">
                        <div class="position-relative text-center">
                            <div class="team-text bg-primary text-white">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team position-relative overflow-hidden mb-5">
                        <img class="img-fluid" src="/images/frontoffice/team-4.jpg" alt="">
                        <div class="position-relative text-center">
                            <div class="team-text bg-primary text-white">
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-6 pb-5 pb-lg-0">
                    <img class="img-fluid w-100" src="/images/frontoffice/testimonial.jpg" alt="">
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="position-relative">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <img class="img-fluid rounded-circle" src="/images/frontoffice/testimonial-1.jpg" style="width: 60px; height: 60px;" alt="">
                                <div class="ml-3">
                        ...
                        <div class="position-relative">
                            <i class="fa fa-3x fa-quote-right text-primary position-absolute" style="top: -6px; right: 0;"></i>
                            <div class="d-flex align-items-center mb-3">
                                <img class="img-fluid rounded-circle" src="/images/frontoffice/testimonial-2.jpg" style="width: 60px; height: 60px;" alt="">
                                <div class="ml-3">
                                    <h6 class="text-uppercase">Client Name</h6>
                                    <span>Profession</span>
                                </div>
                        ...
                        <div class="position-relative">
                            <i class="fa fa-3x fa-quote-right text-primary position-absolute" style="top: -6px; right: 0;"></i>
                            <div class="d-flex align-items-center mb-3">
                                <img class="img-fluid rounded-circle" src="/images/frontoffice/testimonial-3.jpg" style="width: 60px; height: 60px;" alt="">
                                <div class="ml-3">
                                    <h6 class="text-uppercase">Client Name</h6>
                                    <span>Profession</span>
                                </div>
